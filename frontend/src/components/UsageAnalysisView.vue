...
function money(value) { const amount = Number(value || 0) / 1_000_000; return `¥${amount < .01 ? amount.toFixed(4) : amount.toFixed(2)}`; }
function syncQuery() {
  const query = {};
